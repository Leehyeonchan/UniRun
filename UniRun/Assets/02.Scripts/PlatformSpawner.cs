...
// 이전 총알생겅기에서 사용했던 'Instabtuate' (생성) 방식이 아닌
// 오브젝트 폴링 방식을 사용할꺼에요.
// 오브젝트 폴링 (Object pooling) ?
...
public class PlatformSpawner : MonoBehaviour
{
    ...
    public float yMin = -3.5f;// 배치할 위치의 최소y값
    ...
    void Start()
    {
        ...
        {
            // platformPrefab 원본으로 새 발판을 poolPosition 위치에 복제 생성
    ...
    void Update()
    {
        ...
        if(Time.time >= lastSpawnTime + timeBetSpawn)
        {
            ...
            // 이때 발판의Platform 컴포넌트의 OnEnable 메서드가 실행됨
